...
export function MutationLockOverlay() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-panel bg-surface px-5 py-3.5 shadow-lift ring-1 ring-fill-subtle">
        <Spinner className="text-accent" />
        <span className="text-[13px] text-fg-secondary">Guardando…</span>
      </div>
    </div>
  )
}
