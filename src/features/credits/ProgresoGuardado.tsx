 ...
 *  superficie que se eleva por luminosidad (`bg-fill-subtle`), acento ácido reservado al dato que
...
export function ProgresoGuardado({ percent }: { percent: number }) {
  ...
  return (
    ...
    >
      <div className="h-full rounded-full bg-accent transition-[width] duration-300" style={{ width: `${clamped}%` }} />
    </div>
  )
}
